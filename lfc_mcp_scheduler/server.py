"""MCP Server for Schedule Management."""
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "schedule_id": {
                        "type": "string",
                        "description": "日程安排ID（可选，默认使用当前日程）"
                    }
                }
            }
        ),
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "start_datetime": {
                        "type": "string",
                        "description": "开始时间 (ISO格式: YYYY-MM-DDTHH:MM:SS)"
                    },
                    "end_datetime": {
                        "type": "string",
                    ...
                    "repeat_type": {
                        ...
                        "description": "重复类型（可选，默认none）"
                    },
                    "repeat_until": {
                        "type": "string",
                        "description": "重复结束日期 (ISO格式: YYYY-MM-DD，可选)"
                    },
                    "schedule_id": {
                        "type": "string",
                        "description": "日程安排ID（可选，默认使用当前日程）"
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "end_datetime": {
                        "type": "string",
                        "description": "结束时间 (ISO格式: YYYY-MM-DDTHH:MM:SS)"
                    },
                    "description": {
                        "type": "string",
                        "description": "事件描述"
                    ...
                    "repeat_until": {
                        "type": "string",
                        "description": "重复结束日期 (ISO格式: YYYY-MM-DD)"
                    },
                    "schedule_id": {
                        "type": "string",
                        "description": "日程安排ID（可选，默认使用当前日程）"
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "start_date": {
                        "type": "string",
                        "description": "开始日期 (ISO格式: YYYY-MM-DD)"
                    },
                    "end_date": {
                        "type": "string",
                        "description": "结束日期 (ISO格式: YYYY-MM-DD)"
                    },
                    "schedule_id": {
                        "type": "string",
                        "description": "日程安排ID（可选，默认使用当前日程）"
